...
public class WeixiushenqingController {
    ...
    public R page(@RequestParam Map<String, Object> params,WeixiushenqingEntity weixiushenqing,
		...
		if(tableName.equals("yihurenyuan")) {
			weixiushenqing.setRenyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("weixiuyuan")) {
			weixiushenqing.setWeixiuyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
